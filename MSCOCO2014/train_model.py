...
file_name = 'weights/weights-COCO-{epoch:02d}-{loss:.2f}.hdf5'
...
image_caption_model.fit_generator(train_generator, steps_per_epoch=cg.total_samples//batch_size, epochs=30, verbose=1, callbacks=[checkpoint, early])